...
object FakeMovieDataSource {
    val dummyMovieList: List<Movie> by lazy {
        val jsonArray = getMoviesJsonArray()
        parseMovies(jsonArray)
    }

    private fun getMoviesJsonArray(): JSONArray {
        val json = """
         {
           "movies": [
             {
               ...
               "vote_average": 8.387,
               "vote_count": 30122,
               "genres": "Adventure, Drama, Sci-Fiction",
             ...
             },
             {
               ...
               "vote_average": 8.0,
               "vote_count": 16223,
               "genres": "Action, Adventure, Sci-Fiction",
             ...
             },
             {
               ...
               "vote_average": 8.275,
               "vote_count": 22327,
               "genres": "Adventure, Action, Sci-Fiction",
        ...
        return JSONObject(json).getJSONArray("movies")
    }

    private fun parseMovies(jsonArray: JSONArray): List<Movie> {
        ...
        for (i in 0 until jsonArray.length()) {
            ...
            val genres = movieJson.getString("genres")
            val overview = movieJson.getString("overview")
            val posterPath = "https://image.tmdb.org/t/p/w185${movieJson.getString("poster_path")}"
            val releaseDate = movieJson.getString("release_date")
            val voteAverage = movieJson.getDouble("vote_average")
            val voteCount = movieJson.getInt("vote_count")
