...
import com.capstone.mycomposeapp.ui.screens.detail.DetailHotelViewModel
...
class ViewModelFactory(private val repository: MovieRepository) :
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        } else if (modelClass.isAssignableFrom(DetailHotelViewModel::class.java)) {
            return DetailHotelViewModel(repository) as T
        }
